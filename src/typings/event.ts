...
export interface LoadedSlashArgs {
    commands: LoadedSlashArgsCommand;
    commandsArray: LoadedSlashArgs[];
    client: InfiniteClient;
}

export interface LoadedSlashArgsCommand {
    command: RESTPostAPIApplicationCommandsJSONBody, type: "Global" | "Guild"
}